...
public class ConfigManager {
    ...
    public static class Option<T> {
        ...
        public static void initialize() {
            ...
            WORLDGUARD_HOOK = new Option<>(SettingType.BOOLEAN, "enable-worldguard-hook", Collections.singletonList("Whether to enable the WorldGuard hook automatically (can be disabled to improve performance if the hook is not used)"), true);
            ...
            ORIGIN_SELECTION_CONFIRM_SELECTION = new Option<>(SettingType.BOOLEAN, "origin-selection.confirm-selection", "Confirm the origin selection by double clicking the button", false);
            ...
            MAX_SAME_ORIGIN = new Option<>(SettingType.INTEGER, "restrictions.max_same_origin", List.of(
            ...
            REFRESH_RATE = new Option<>(SettingType.INTEGER, "refresh-rate", "How many ticks apart should the plugin refresh be, increasing this number will improve performance but will cause issues if too high", 4);
