...
public class MVE_V1_18_1 extends MultiVersionExecutor {
    ...
    public Component applyFont(Component component, Key font) {
        return Component.text().append(component).font(font).build();
    }
    ...
    public void dealExplosionDamage(Player player, int amount) {
        ServerPlayer serverPlayer = ((CraftPlayer) player).getHandle();
        serverPlayer.hurt(DamageSource.explosion((net.minecraft.world.entity.LivingEntity) null), amount);
    }
    ...
    public void dealSonicBoomDamage(LivingEntity entity, int amount, Player source) {
        ...
        e.hurt(DamageSource.sting(serverPlayer), amount);
    }
